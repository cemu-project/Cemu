...
#### Troubleshooting steps
 ...
 - If step 4 gives you `fatal error: 'span' file not found`, then you're missing `libstdc++`. Install with your package manager, eg `sudo apt install libstdc++-10-dev`. See #644.
