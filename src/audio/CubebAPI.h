...
class CubebAPI : public IAudioAPI
{
  public:
	...
	CubebAPI(cubeb_devid devid, uint32 samplerate, uint32 channels, uint32 samples_per_block,
  ...
  private:
	...
	static long data_cb(cubeb_stream* stream, void* user, const void* inputbuffer,
