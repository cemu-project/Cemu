...
//  ImGui_ImplOpenGL3_CreateFontsTexture() before the first NewFrame() call. 2019-05-29: OpenGL:
//  Desktop GL only: Added support for large mesh (64K+ vertices), enable
											   ...
											   GLuint vertex_array_object)
{
	...
	glBlendFuncSeparatei(0, GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA, GL_SRC_ALPHA,
...
void ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data)
{
	...
	// (GLint*)&last_blend_src_alpha); GLenum last_blend_dst_alpha;
	// glGetIntegerv(GL_BLEND_DST_ALPHA, (GLint*)&last_blend_dst_alpha); GLenum
	// last_blend_equation_rgb; glGetIntegerv(GL_BLEND_EQUATION_RGB,
	// (GLint*)&last_blend_equation_rgb); GLenum last_blend_equation_alpha;
	// glGetIntegerv(GL_BLEND_EQUATION_ALPHA, (GLint*)&last_blend_equation_alpha); GLboolean
	// last_enable_blend = false; glIsEnabled(GL_BLEND);
	...
	// last_blend_dst_alpha); if (last_enable_blend) glEnable(GL_BLEND); else glDisable(GL_BLEND);
