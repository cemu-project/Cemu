...
IMGUI_IMPL_API void ImGui_ImplVulkan_NewFrame(VkCommandBuffer command_buffer,
...
IMGUI_IMPL_API void ImGui_ImplVulkan_SetMinImageCount(
	uint32_t min_image_count); // To override MinImageCount after initialization (e.g. if swap chain
							   // is recreated)
//
// IMGUI_IMPL_API bool           ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info, VkRenderPass
// render_pass); IMGUI_IMPL_API void           ImGui_ImplVulkan_Shutdown(); IMGUI_IMPL_API void
// ImGui_ImplVulkan_NewFrame(); IMGUI_IMPL_API void ImGui_ImplVulkan_RenderDrawData(ImDrawData*
// draw_data, VkCommandBuffer command_buffer); IMGUI_IMPL_API bool
// ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer); IMGUI_IMPL_API void
// ImGui_ImplVulkan_InvalidateFontUploadObjects();
IMGUI_IMPL_API ImTextureID ImGui_ImplVulkan_AddTexture(VkSampler sampler, VkImageView image_view,
													   VkImageLayout image_layout);
IMGUI_IMPL_API ImTextureID ImGui_ImplVulkan_GenerateTexture(VkCommandBuffer commandBuffer,
