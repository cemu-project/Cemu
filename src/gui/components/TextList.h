...
class TextList : public wxControl, public wxScrollHelper
{
  public:
	virtual ~TextList();
	TextList(wxWindow* parent, wxWindowID id, const wxPoint& pos = wxDefaultPosition,
	...
	void DrawLineBackground(wxDC& dc, const wxPoint& position, const wxColour& colour,
							uint32 lines = 1) const;
