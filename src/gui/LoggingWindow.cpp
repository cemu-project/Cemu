...
LoggingWindow::LoggingWindow(wxFrame* parent)
	: wxFrame(parent, wxID_ANY, _("Logging window"), wxDefaultPosition, wxSize(800, 600),
			  wxDEFAULT_FRAME_STYLE | wxTAB_TRAVERSAL)
{
	auto* sizer = new wxBoxSizer(wxVERTICAL);
	{
		...
		filter_row->Add(new wxStaticText(this, wxID_ANY, _("Filter")), 0,
						wxALIGN_CENTER_VERTICAL | wxALL, 5);

		wxString choices[] = {"Coreinit File-Access",
							  "Coreinit Thread-Synchronization",
							  "Coreinit Memory",
							  "GX2",
							  "Audio",
							  "Input",
							  ...
							  "Texture Cache",
							  "OpenGL"};
		m_filter = new wxComboBox(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
								  std::size(choices), choices, 0);
	...
	m_log_list =
		new wxLogCtrl(this, wxID_ANY, wxDefaultPosition, wxDefaultSize,
					  wxScrolledWindowStyle | wxVSCROLL); //( this, wxID_ANY, wxDefaultPosition,
														  // wxDefaultSize, 0, NULL, wxLB_HSCROLL );
