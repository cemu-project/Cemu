...
SymbolWindow::SymbolWindow(DebuggerWindow2& parent, const wxPoint& main_position,
						   const wxSize& main_size)
	: wxFrame(&parent, wxID_ANY, _("Symbol Window"), wxDefaultPosition, wxSize(600, 250),
				  ...
				  wxFRAME_FLOAT_ON_PARENT)
{
	...
	m_filter = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
							  wxTE_NO_VSCROLL);
