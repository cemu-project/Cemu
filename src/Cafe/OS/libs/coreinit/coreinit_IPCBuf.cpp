...
IPCBufPool_t* IPCBufPoolCreate(uint8* bufferArea, uint32 bufferSize, uint32 entrySize,
							   uint32be* entryCountOutput, uint32 uknR7)
{
...
void coreinitExport_IPCBufPoolCreate(PPCInterpreter_t* hCPU)
{
	...
	IPCBufPool_t* ipcBufPool =
		IPCBufPoolCreate(bufferArea, bufferSize, entrySize, entryCountOutput, uknR7);
	osLib_returnFromFunction(hCPU, memory_getVirtualOffsetFromPointer(ipcBufPool));
	return;
	// example dump of IPC buffer (at 0x1011FF40):
	// 0000   0B AD F0 0D 10 11 FF 40  00 00 53 01 00 00 00 01  00 00 00 00 00 00 02 C0  00 00 02 C0
	// 00 00 00 1D 0020   10 12 00 40 00 00 00 78  00 00 00 00 00 00 00 00  00 00 00 1D 00 00 00 1D
	// 10 11 FF A8 6D 55 74 58 0040   10 00 87 2C 00 00 00 00  00 00 00 00 00 00 00 00  10 11 FF 7C
	// 00 00 00 00  00 00 00 00 00 00 00 00 0060   00 00 00 00 00 00 00 00  10 12 00 40 10 12 03 00
	// 10 12 05 C0 10 12 08 80  10 12 0B 40 10 12 0E 00 0080   10 12 10 C0 10 12 13 80  10 12 16 40
	// 10 12 19 00  10 12 1B C0 10 12 1E 80  10 12 21 40 10 12 24 00 00A0   10 12 26 C0 10 12 29 80
	// 10 12 2C 40 10 12 2F 00  10 12 31 C0 10 12 34 80  10 12 37 40 10 12 3A 00 00C0   10 12 3C C0
	// 10 12 3F 80  10 12 42 40 10 12 45 00  10 12 47 C0 10 12 4A 80  10 12 4D 40 00 00 00 00 00E0
