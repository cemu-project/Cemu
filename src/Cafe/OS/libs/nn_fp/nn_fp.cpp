...
void export_SetNotificationHandler(PPCInterpreter_t* hCPU)
{
	...
	forceLogDebug_printf("nn_fp.SetNotificationHandler(0x%08x,0x%08x,0x%08x)", hCPU->gpr[3],
...
{
	forceLogDebug_printf("nn_fp.GetFriendAccountId(0x%08x,0x%08x,0x%08x)", hCPU->gpr[3],
						 hCPU->gpr[4], hCPU->gpr[5]);
...
void export_GetFriendScreenName(PPCInterpreter_t* hCPU)
{
	...
	forceLogDebug_printf("nn_fp.GetFriendScreenName(0x%08x,0x%08x,0x%08x,%d,0x%08x)", hCPU->gpr[3],
...
{
	forceLogDebug_printf("nn_fp.GetFriendMii(0x%08x,0x%08x,0x%08x)", hCPU->gpr[3], hCPU->gpr[4],
						 hCPU->gpr[5]);
...
{
	forceLogDebug_printf("nn_fp.GetFriendPresence(0x%08x,0x%08x,0x%08x)", hCPU->gpr[3],
						 hCPU->gpr[4], hCPU->gpr[5]);
...
{
	forceLogDebug_printf("nn_fp.GetFriendRelationship(0x%08x,0x%08x,0x%08x)", hCPU->gpr[3],
						 hCPU->gpr[4], hCPU->gpr[5]);
...
void export_IsJoinable(PPCInterpreter_t* hCPU)
{
	...
	if (presence->isValid == 0 || presence->isOnline == 0 || presence->gameMode.joinGameId == 0 ||
		presence->gameMode.matchmakeType == 0 || presence->gameMode.groupId == 0 ||
...
{
	forceLogDebug_printf("nn_fp.CheckSettingStatusAsync(0x%08x,0x%08x,0x%08x) - placeholder",
...
{
	forceLogDebug_printf("nn_fp.UpdatePreferenceAsync(0x%08x,0x%08x,0x%08x) - placeholder",
						 hCPU->gpr[3], hCPU->gpr[4], hCPU->gpr[5]);
	ppcDefineParamTypePtr(uknR3, uint8, 0);
	ppcDefineParamMPTR(funcMPTR, 1);
	ppcDefineParamU32(customParam, 2);
...
{
	forceLogDebug_printf("nn_fp.UpdateGameMode(0x%08x,0x%08x,%d)", hCPU->gpr[3], hCPU->gpr[4],
						 hCPU->gpr[5]);
...
void export_GetRequestBlockSettingAsync(PPCInterpreter_t* hCPU)
{
	...
	// 1 means blocked. Friend app will continue with AddFriendAsync to add the user as a
	// provisional friend
...
void load()
{
	...
	osLib_addFunction("nn_fp", "GetFriendRequestList__Q2_2nn2fpFPUiT1UiT3",
					  export_GetFriendRequestList);
	osLib_addFunction("nn_fp", "GetFriendListAll__Q2_2nn2fpFPUiT1UiT3", export_GetFriendListAll);
	osLib_addFunction("nn_fp", "GetFriendListEx__Q2_2nn2fpFPQ3_2nn2fp10FriendDataPCUiUi",
					  export_GetFriendListEx);
	osLib_addFunction("nn_fp", "GetFriendRequestListEx__Q2_2nn2fpFPQ3_2nn2fp13FriendRequestPCUiUi",
					  export_GetFriendRequestListEx);
	osLib_addFunction(
		"nn_fp", "GetBasicInfoAsync__Q2_2nn2fpFPQ3_2nn2fp9BasicInfoPCUiUiPFQ2_2nn6ResultPv_vPv",
		export_GetBasicInfoAsync);
	...
	osLib_addFunction("nn_fp", "GetMyPreference__Q2_2nn2fpFPQ3_2nn2fp10Preference",
					  export_GetMyPreference);

	osLib_addFunction("nn_fp", "GetFriendAccountId__Q2_2nn2fpFPA17_cPCUiUi",
					  export_GetFriendAccountId);
	osLib_addFunction("nn_fp", "GetFriendScreenName__Q2_2nn2fpFPA11_wPCUiUibPUc",
					  export_GetFriendScreenName);
	osLib_addFunction("nn_fp", "GetFriendMii__Q2_2nn2fpFP12FFLStoreDataPCUiUi",
					  export_GetFriendMii);
	osLib_addFunction("nn_fp", "GetFriendPresence__Q2_2nn2fpFPQ3_2nn2fp14FriendPresencePCUiUi",
					  export_GetFriendPresence);
	osLib_addFunction("nn_fp", "GetFriendRelationship__Q2_2nn2fpFPUcPCUiUi",
					  export_GetFriendRelationship);
	osLib_addFunction("nn_fp", "IsJoinable__Q2_2nn2fpFPCQ3_2nn2fp14FriendPresenceUL",
					  export_IsJoinable);

	osLib_addFunction("nn_fp", "CheckSettingStatusAsync__Q2_2nn2fpFPUcPFQ2_2nn6ResultPv_vPv",
					  export_CheckSettingStatusAsync);
	osLib_addFunction("nn_fp", "IsPreferenceValid__Q2_2nn2fpFv", export_IsPreferenceValid);
	osLib_addFunction(
		"nn_fp", "UpdatePreferenceAsync__Q2_2nn2fpFPCQ3_2nn2fp10PreferencePFQ2_2nn6ResultPv_vPv",
		export_UpdatePreferenceAsync);

	osLib_addFunction("nn_fp", "UpdateGameMode__Q2_2nn2fpFPCQ3_2nn2fp8GameModePCwUi",
					  export_UpdateGameMode);

	osLib_addFunction("nn_fp",
					  "GetRequestBlockSettingAsync__Q2_2nn2fpFPUcPCUiUiPFQ2_2nn6ResultPv_vPv",
					  export_GetRequestBlockSettingAsync);

	osLib_addFunction("nn_fp", "AddFriendAsync__Q2_2nn2fpFPCcPFQ2_2nn6ResultPv_vPv",
					  export_AddFriendAsync);
	osLib_addFunction(
		"nn_fp",
		"AddFriendRequestAsync__Q2_2nn2fpFPCQ3_2nn2fp18RecentPlayRecordExPCwPFQ2_2nn6ResultPv_vPv",
		export_AddFriendRequestAsync);
	osLib_addFunction("nn_fp", "DeleteFriendFlagsAsync__Q2_2nn2fpFPCUiUiT2PFQ2_2nn6ResultPv_vPv",
					  export_DeleteFriendFlagsAsync);

	osLib_addFunction("nn_fp", "RemoveFriendAsync__Q2_2nn2fpFUiPFQ2_2nn6ResultPv_vPv",
					  export_RemoveFriendAsync);
	osLib_addFunction("nn_fp",
					  "MarkFriendRequestsAsReceivedAsync__Q2_2nn2fpFPCULUiPFQ2_2nn6ResultPv_vPv",
					  export_MarkFriendRequestsAsReceivedAsync);
	osLib_addFunction("nn_fp", "CancelFriendRequestAsync__Q2_2nn2fpFULPFQ2_2nn6ResultPv_vPv",
					  export_CancelFriendRequestAsync);
	osLib_addFunction("nn_fp", "AcceptFriendRequestAsync__Q2_2nn2fpFULPFQ2_2nn6ResultPv_vPv",
					  export_AcceptFriendRequestAsync);
}
} // namespace fp
} // namespace nn
