...
void nnEcExport___ct__Q3_2nn2ec5MoneyFPCcN21(PPCInterpreter_t* hCPU)
{
	...
	nnEcUknMoneyStruct_t* moneyStruct =
		(nnEcUknMoneyStruct_t*)memory_getPointerFromVirtualOffset(hCPU->gpr[3]);
	// todo -> Setup struct
...
void nnEc_load()
{
	osLib_addFunction("nn_ec", "__ct__Q3_2nn2ec5MoneyFPCcN21",
