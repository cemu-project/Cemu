...
#define BUILD_NN_RESULT(__level, __module, __detailedErrorCode)                                    \
	((((uint32)(__level)&0x7) << 29) | ((uint32)(__module) << 20) |                                \
	 ((uint32)(__detailedErrorCode) << 0))
#define BUILD_NN_RESULT_STATUS(__module, __detailedErrorCode)                                      \
	((((uint32)NN_RESULT_LEVEL_STATUS) << 29) | ((uint32)(__module) << 20) |                       \
	 ((uint32)(__detailedErrorCode) << 0))
...
// 0000-9999
// these are the user-facing error codes you see in ErrEula. Usually combined with a module-specific
// prefix. E.g. 102-1234 in nnResult these are stored in the description field left-shifted by 7
