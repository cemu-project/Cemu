...
const int AX_SAMPLES_MAX =
	AX_SAMPLES_PER_3MS_48KHZ; // the maximum amount of samples in a single frame
...
sint32 AXAcquireMultiVoice(sint32 voicePriority, void* cbFunc, void* cbData,
						   AXMULTIVOICEUKNSTRUCT* uknR6, MEMPTR<AXVPBMULTI>* multiVoiceOut);
void AXFreeMultiVoice(AXVPBMULTI* multiVoice);
sint32 AXGetMultiVoiceReformatBufferSize(sint32 voiceFormat, uint32 channelCount,
										 uint32 sizeInBytes, uint32be* sizeOutput);
