...
{
	SUCCESS = 0,
	END_ITERATION = -2, // used by FSGetMountSource / FSGetMountSourceNext to indicate when last
						// element was reached
	FATAL_ERROR = -0x400,
...
// todo - error handling in the IOSU part is pretty hacky right now and we use FS_RESULT in most
// places which we shouldn't be doing. Rework it
