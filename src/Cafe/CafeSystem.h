...
enum class STATUS_CODE
{
	SUCCESS,
	INVALID_RPX,
	UNABLE_TO_MOUNT, // failed to mount through TitleInfo (most likely caused by an invalid or
					 // outdated path)
	// BAD_META_DATA, - the title list only stores titles with valid meta, so this error code is
	// impossible
};
