...
uint32 ComputeSurfaceBankSwappedWidth(Latte::E_HWTILEMODE tileMode, uint32 bpp, uint32 numSamples,
									  uint32 pitch);

void GX2CalculateSurfaceInfo(Latte::E_GX2SURFFMT surfaceFormat, uint32 surfaceWidth,
							 uint32 surfaceHeight, uint32 surfaceDepth, Latte::E_DIM surfaceDim,
							 Latte::E_GX2TILEMODE surfaceTileMode, uint32 surfaceAA, uint32 level,
							 AddrSurfaceInfo_OUT* pSurfOut, bool optimizeForDepthBuffer = false,
							 bool optimizeForScanBuffer = false);
uint32 CalculateMipOffset(Latte::E_GX2SURFFMT format, uint32 width, uint32 height, uint32 depth,
						  Latte::E_DIM dim, Latte::E_HWTILEMODE tileMode, uint32 swizzle,
						  uint32 surfaceAA, sint32 mipIndex);
...
uint32 _ComputePixelIndexWithinMicroTile(uint32 x, uint32 y, uint32 z, uint32 bpp,
										 Latte::E_HWTILEMODE tileMode, uint32 microTileType);
...
void SetupCachedSurfaceAddrInfo(CachedSurfaceAddrInfo* info, uint32 slice, uint32 sample,
								...
								uint32 numSamples, Latte::E_HWTILEMODE tileMode, int isDepth,
