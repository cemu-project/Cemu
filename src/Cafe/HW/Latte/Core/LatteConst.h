...
#define LATTE_NUM_MAX_TEX_UNITS                                                                    \
	(18) // number of available texture units per shader stage (this might be higher than 18? BotW
		 // is the only game which uses more than 16?)
