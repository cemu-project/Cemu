...
void LatteShaderCache_load()
{
	...
	// create directories
	std::error_code ec;
	fs::create_directories(GetPath(ActiveSettings::GetUserDataPath(), "shaderCache/transferable"), ec);
	fs::create_directories(GetPath(ActiveSettings::GetUserDataPath(), "shaderCache/precompiled"), ec);
	...
	// get cache file name
	const auto pathGeneric = GetPath(ActiveSettings::GetUserDataPath(), "shaderCache/transferable/{:016x}_shaders.bin", cacheTitleId);
	const auto pathGenericPre1_25_0 = GetPath(ActiveSettings::GetUserDataPath(), "shaderCache/transferable/{:016x}.bin", cacheTitleId); // before 1.25.0
	const auto pathGenericPre1_16_0 = GetPath(ActiveSettings::GetUserDataPath(), "shaderCache/transferable/{:08x}.bin", CafeSystem::GetRPXHashBase()); // before 1.16.0
