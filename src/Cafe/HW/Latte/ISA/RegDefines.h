...
#define mmSQ_VTX_UNIFORM_BLOCK_START                                                               \
	(mmSQ_TEX_RESOURCE_WORD0 + 0x7E0) // 7 dwords for each uniform block
#define mmSQ_VTX_UNIFORM_BLOCK_END (mmSQ_VTX_UNIFORM_BLOCK_START + 7 * 16 - 1)

#define mmSQ_PS_UNIFORM_BLOCK_START                                                                \
	(mmSQ_TEX_RESOURCE_WORD0 + 0x250) // 7 dwords for each uniform block
#define mmSQ_PS_UNIFORM_BLOCK_END (mmSQ_PS_UNIFORM_BLOCK_START + 7 * 16 - 1)

#define mmSQ_GS_UNIFORM_BLOCK_START                                                                \
	(mmSQ_TEX_RESOURCE_WORD0 + 0xCB0) // 7 dwords for each uniform block
