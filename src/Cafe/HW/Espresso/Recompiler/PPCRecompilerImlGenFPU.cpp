...
void PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
	ppcImlGenContext_t* ppcImlGenContext, uint8 registerDestination, uint8 registerMemory,
	sint32 immS32, uint32 mode, bool switchEndian, uint8 registerGQR = PPC_REC_INVALID_REGISTER)
{
	// load from memory
...
void PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory_indexed(
	ppcImlGenContext_t* ppcImlGenContext, uint8 registerDestination, uint8 registerMemory1,
	uint8 registerMemory2, uint32 mode, bool switchEndian,
	uint8 registerGQR = PPC_REC_INVALID_REGISTER)
{
	// load from memory
	PPCRecImlInstruction_t* imlInstruction =
		PPCRecompilerImlGen_generateNewEmptyInstruction(ppcImlGenContext);
...
void PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r(
	ppcImlGenContext_t* ppcImlGenContext, uint8 registerSource, uint8 registerMemory, sint32 immS32,
	uint32 mode, bool switchEndian, uint8 registerGQR = PPC_REC_INVALID_REGISTER)
{
	// store to memory
	PPCRecImlInstruction_t* imlInstruction =
		PPCRecompilerImlGen_generateNewEmptyInstruction(ppcImlGenContext);
...
void PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r_indexed(
	ppcImlGenContext_t* ppcImlGenContext, uint8 registerSource, uint8 registerMemory1,
...
void PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
	ppcImlGenContext_t* ppcImlGenContext, sint32 operation, uint8 registerResult,
	uint8 registerOperand, sint32 crRegister = PPC_REC_INVALID_REGISTER)
{
	// fpr OP fpr
	PPCRecImlInstruction_t* imlInstruction =
		PPCRecompilerImlGen_generateNewEmptyInstruction(ppcImlGenContext);
...
void PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r(
	ppcImlGenContext_t* ppcImlGenContext, sint32 operation, uint8 registerResult,
	uint8 registerOperand1, uint8 registerOperand2, sint32 crRegister = PPC_REC_INVALID_REGISTER)
{
	// fpr = OP (fpr,fpr)
	PPCRecImlInstruction_t* imlInstruction =
		PPCRecompilerImlGen_generateNewEmptyInstruction(ppcImlGenContext);
...
void PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r_r(
	ppcImlGenContext_t* ppcImlGenContext, sint32 operation, uint8 registerResult,
	uint8 registerOperandA, uint8 registerOperandB, uint8 registerOperandC,
	sint32 crRegister = PPC_REC_INVALID_REGISTER)
{
	// fpr = OP (fpr,fpr,fpr)
	PPCRecImlInstruction_t* imlInstruction =
		PPCRecompilerImlGen_generateNewEmptyInstruction(ppcImlGenContext);
...
void PPCRecompilerImlGen_generateNewInstruction_fpr_r(ppcImlGenContext_t* ppcImlGenContext,
													  PPCRecImlInstruction_t* imlInstruction,
													  sint32 operation, uint8 registerResult,
													  sint32 crRegister)
{
	// OP (fpr)
 ...
 */
void PPRecompilerImmGen_optionalRoundBottomFPRToSinglePrecision(
	ppcImlGenContext_t* ppcImlGenContext, uint32 fprRegister, bool flushDenormals = false)
{
	PPCRecompilerImlGen_generateNewInstruction_fpr_r(
		ppcImlGenContext, NULL, PPCREC_IML_OP_FPR_ROUND_TO_SINGLE_PRECISION_BOTTOM, fprRegister);
	if (flushDenormals)
		assert_dbg();
}
 ...
 */
void PPRecompilerImmGen_optionalRoundPairFPRToSinglePrecision(ppcImlGenContext_t* ppcImlGenContext,
															  uint32 fprRegister,
															  bool flushDenormals = false)
{
	PPCRecompilerImlGen_generateNewInstruction_fpr_r(
		ppcImlGenContext, NULL, PPCREC_IML_OP_FPR_ROUND_TO_SINGLE_PRECISION_PAIR, fprRegister);
	if (flushDenormals)
		assert_dbg();
}
...
bool PPCRecompilerImlGen_LFS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegister =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	if (ppcImlGenContext->LSQE)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
			ppcImlGenContext, fprRegister, gprRegister, imm, PPCREC_FPR_LD_MODE_SINGLE_INTO_PS0_PS1,
			true);
	}
	else
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
			ppcImlGenContext, fprRegister, gprRegister, imm, PPCREC_FPR_LD_MODE_SINGLE_INTO_PS0,
			true);
	}
	return true;
}
...
bool PPCRecompilerImlGen_LFSU(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
			ppcImlGenContext, fprRegister, gprRegister, 0, PPCREC_FPR_LD_MODE_SINGLE_INTO_PS0_PS1,
			true);
	}
	else
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
			ppcImlGenContext, fprRegister, gprRegister, 0, PPCREC_FPR_LD_MODE_SINGLE_INTO_PS0,
			true);
	}
	return true;
}
...
bool PPCRecompilerImlGen_LFSX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (ppcImlGenContext->LSQE)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory_indexed(
			ppcImlGenContext, fprRegister, gprRegister1, gprRegister2,
			PPCREC_FPR_LD_MODE_SINGLE_INTO_PS0_PS1, true);
	}
	else
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory_indexed(
			ppcImlGenContext, fprRegister, gprRegister1, gprRegister2,
			PPCREC_FPR_LD_MODE_SINGLE_INTO_PS0, true);
	}
	return true;
}
...
bool PPCRecompilerImlGen_LFSUX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
			ppcImlGenContext, fprRegister, gprRegister1, 0, PPCREC_FPR_LD_MODE_SINGLE_INTO_PS0_PS1,
			true);
	}
	else
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
			ppcImlGenContext, fprRegister, gprRegister1, 0, PPCREC_FPR_LD_MODE_SINGLE_INTO_PS0,
			true);
	}
	return true;
}
...
bool PPCRecompilerImlGen_LFD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegister =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
		ppcImlGenContext, fprRegister, gprRegister, imm, PPCREC_FPR_LD_MODE_DOUBLE_INTO_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_LFDU(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// emit load iml
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
		ppcImlGenContext, fprRegister, gprRegister, 0, PPCREC_FPR_LD_MODE_DOUBLE_INTO_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_LFDX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory_indexed(
		ppcImlGenContext, fprRegister, gprRegister1, gprRegister2,
		PPCREC_FPR_LD_MODE_DOUBLE_INTO_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_LFDUX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegister =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
		ppcImlGenContext, fprRegister, gprRegister1, 0, PPCREC_FPR_LD_MODE_DOUBLE_INTO_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_STFS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// get fpr register index
	uint32 fprRegister =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);

	PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r(
		ppcImlGenContext, fprRegister, gprRegister, imm, PPCREC_FPR_ST_MODE_SINGLE_FROM_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_STFSU(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r(
		ppcImlGenContext, fprRegister, gprRegister, 0, PPCREC_FPR_ST_MODE_SINGLE_FROM_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_STFSX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// get fpr register index
	uint32 fprRegister =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frS);
	if (ppcImlGenContext->LSQE)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r_indexed(
			ppcImlGenContext, fprRegister, gprRegister1, gprRegister2, 0,
			PPCREC_FPR_ST_MODE_SINGLE_FROM_PS0, true);
	}
	else
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r_indexed(
...
bool PPCRecompilerImlGen_STFSUX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r(
		ppcImlGenContext, fprRegister, gprRegister1, 0, PPCREC_FPR_ST_MODE_SINGLE_FROM_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_STFD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegister =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r(
		ppcImlGenContext, fprRegister, gprRegister, imm, PPCREC_FPR_ST_MODE_DOUBLE_FROM_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_STFDU(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r(
		ppcImlGenContext, fprRegister, gprRegister, 0, PPCREC_FPR_ST_MODE_DOUBLE_FROM_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_STFDX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (ppcImlGenContext->LSQE)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r_indexed(
			ppcImlGenContext, fprRegister, gprRegister1, gprRegister2, 0,
			PPCREC_FPR_ST_MODE_DOUBLE_FROM_PS0, true);
	}
	else
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r_indexed(
...
bool PPCRecompilerImlGen_STFIWX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (rA != 0)
		PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r_indexed(
			ppcImlGenContext, fprRegister, gprRegister1, gprRegister2, 0,
			PPCREC_FPR_ST_MODE_UI32_FROM_PS0, true);
	else
		PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r(
			ppcImlGenContext, fprRegister, gprRegister1, 0, PPCREC_FPR_ST_MODE_UI32_FROM_PS0, true);
	return true;
}
...
bool PPCRecompilerImlGen_FADD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// load registers
	uint32 fprRegisterA =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frA);
	uint32 fprRegisterB =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frB);
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);

	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_ADD_BOTTOM, fprRegisterD, fprRegisterA, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_FSUB(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_SUB_BOTTOM, fprRegisterD, fprRegisterA, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_FMUL(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterA =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frA);
	uint32 fprRegisterC =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frC);
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	// move frA to frD (if different register)
	if (fprRegisterD != fprRegisterA)
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(ppcImlGenContext, PPCREC_IML_OP_ASSIGN,
														   fprRegisterD,
														   fprRegisterA); // always copy ps0 and ps1
	// multiply bottom double of frD with bottom double of frB
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_MULTIPLY_BOTTOM, fprRegisterD, fprRegisterC);
	return true;
}
...
bool PPCRecompilerImlGen_FDIV(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (frB == frD && frA != frB)
	{
		uint32 fprRegisterTemp = PPCRecompilerImlGen_loadOverwriteFPRRegister(
			ppcImlGenContext, PPCREC_NAME_TEMPORARY_FPR0 + 0);
		// move frA to temporary register
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(ppcImlGenContext, PPCREC_IML_OP_ASSIGN,
														   fprRegisterTemp, fprRegisterA);
		// divide bottom double of temporary register by bottom double of frB
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_DIVIDE_BOTTOM, fprRegisterTemp, fprRegisterB);
		// move result to frD
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(ppcImlGenContext,
														   PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM,
														   fprRegisterD, fprRegisterTemp);
		return true;
	}
	// move frA to frD (if different register)
	if (fprRegisterD != fprRegisterA)
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(ppcImlGenContext,
														   PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM,
														   fprRegisterD, fprRegisterA); // copy ps0
	// divide bottom double of frD by bottom double of frB
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_DIVIDE_BOTTOM, fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_FMADD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (frB == frD)
	{
		...
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_MULTIPLY_BOTTOM, fprRegisterTemp, fprRegisterC);
		// add result to frD
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_ADD_BOTTOM, fprRegisterD, fprRegisterTemp);
		return true;
	}
	...
	// add frB
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_ADD_BOTTOM, fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_FMSUB(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// sub frB
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_SUB_BOTTOM, fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_FNMSUB(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (frB == frD)
	{
		...
		uint32 fprRegisterTemp = PPCRecompilerImlGen_loadOverwriteFPRRegister(
			ppcImlGenContext, PPCREC_NAME_TEMPORARY_FPR0 + 0);
		//// negate frB/frD
		// PPCRecompilerImlGen_generateNewInstruction_fpr_r(ppcImlGenContext,
		// NULL,PPCREC_IML_OP_FPR_NEGATE_BOTTOM, fprRegisterD, true);
		//  move frA to temporary register
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(ppcImlGenContext,
														   PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM,
														   fprRegisterTemp, fprRegisterA);
		...
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_SUB_BOTTOM, fprRegisterTemp, fprRegisterB);
		// negate result
		PPCRecompilerImlGen_generateNewInstruction_fpr_r(
			ppcImlGenContext, NULL, PPCREC_IML_OP_FPR_NEGATE_BOTTOM, fprRegisterTemp);
		// move result to frD
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(ppcImlGenContext,
														   PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM,
														   fprRegisterD, fprRegisterTemp);
	...
	if (fprRegisterD != fprRegisterA)
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM, fprRegisterD,
			fprRegisterA); // always copy ps0 and ps1
	// multiply bottom double of frD with bottom double of frC
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_MULTIPLY_BOTTOM, fprRegisterD, fprRegisterC);
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_SUB_BOTTOM, fprRegisterD, fprRegisterB);
	// negate result
	PPCRecompilerImlGen_generateNewInstruction_fpr_r(ppcImlGenContext, NULL,
													 PPCREC_IML_OP_FPR_NEGATE_BOTTOM, fprRegisterD);
	return true;
}
...
bool PPCRecompilerImlGen_FMULS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM_AND_TOP, fprRegisterD,
			fprRegisterD);
	}
...
bool PPCRecompilerImlGen_FMADDS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// if none of the operand registers overlap with the result register then we can avoid the usage
	// of a temporary register
	if (fprRegisterD != fprRegisterA && fprRegisterD != fprRegisterB &&
		fprRegisterD != fprRegisterC)
		fprRegisterTemp = fprRegisterD;
	else
		fprRegisterTemp = PPCRecompilerImlGen_loadOverwriteFPRRegister(
			ppcImlGenContext, PPCREC_NAME_TEMPORARY_FPR0 + 0);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_MULTIPLY_BOTTOM, fprRegisterTemp, fprRegisterA,
		fprRegisterC);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_ADD_BOTTOM, fprRegisterTemp, fprRegisterB);
	// adjust accuracy
...
bool PPCRecompilerImlGen_FCMPO(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterB =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frB);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_FCMPO_BOTTOM, fprRegisterA, fprRegisterB, crfD);
	return true;
}
...
bool PPCRecompilerImlGen_FCMPU(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterB =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frB);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_FCMPU_BOTTOM, fprRegisterA, fprRegisterB, crfD);
	return true;
}
...
bool PPCRecompilerImlGen_FMR(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM, fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_FABS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// abs frD
	PPCRecompilerImlGen_generateNewInstruction_fpr_r(ppcImlGenContext, NULL,
													 PPCREC_IML_OP_FPR_ABS_BOTTOM, fprRegisterD);
	return true;
}
...
bool PPCRecompilerImlGen_FNABS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// abs frD
	PPCRecompilerImlGen_generateNewInstruction_fpr_r(
		ppcImlGenContext, NULL, PPCREC_IML_OP_FPR_NEGATIVE_ABS_BOTTOM, fprRegisterD);
	return true;
}
...
bool PPCRecompilerImlGen_FRES(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_BOTTOM_FRES_TO_BOTTOM_AND_TOP, fprRegisterD,
		fprRegisterB);
	// adjust accuracy
	PPRecompilerImmGen_optionalRoundBottomFPRToSinglePrecision(ppcImlGenContext, fprRegisterD);
	return true;
...
bool PPCRecompilerImlGen_FRSP(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_r(
		ppcImlGenContext, NULL, PPCREC_IML_OP_FPR_ROUND_TO_SINGLE_PRECISION_BOTTOM, fprRegisterD);
	if (ppcImlGenContext->PSE)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM_AND_TOP, fprRegisterD,
...
bool PPCRecompilerImlGen_FSEL(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_SELECT_BOTTOM, fprRegisterD, fprRegisterA, fprRegisterB,
		fprRegisterC);
	return true;
}
...
bool PPCRecompilerImlGen_FRSQRTE(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_BOTTOM_RECIPROCAL_SQRT, fprRegisterD, fprRegisterB);
	// adjust accuracy
	PPRecompilerImmGen_optionalRoundBottomFPRToSinglePrecision(ppcImlGenContext, fprRegisterD);
	return true;
}
...
bool PPCRecompilerImlGen_FCTIWZ(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_BOTTOM_FCTIWZ, fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_PSQ_L(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// get gqr register
	uint32 gqrRegister = PPCRecompilerImlGen_loadRegister(
		ppcImlGenContext, PPCREC_NAME_SPR0 + SPR_UGQR0 + gqrIndex, false);
	// get memory gpr register index
	uint32 gprRegister =
		PPCRecompilerImlGen_loadRegister(ppcImlGenContext, PPCREC_NAME_R0 + rA, false);
	// get fpr register index
	...
	// psq load
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
		ppcImlGenContext, fprRegister, gprRegister, imm,
		readPS1 ? PPCREC_FPR_LD_MODE_PSQ_GENERIC_PS0_PS1 : PPCREC_FPR_LD_MODE_PSQ_GENERIC_PS0, true,
		gqrRegister);
	return true;
}
...
bool PPCRecompilerImlGen_PSQ_LU(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// paired load
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_memory(
		ppcImlGenContext, fprRegister, gprRegister, 0,
		readPS1 ? PPCREC_FPR_LD_MODE_PSQ_GENERIC_PS0_PS1 : PPCREC_FPR_LD_MODE_PSQ_GENERIC_PS0, true,
		gqrRegister);
	return true;
}
...
bool PPCRecompilerImlGen_PSQ_ST(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_memory_r(
		ppcImlGenContext, fprRegister, gprRegister, imm,
		storePS1 ? PPCREC_FPR_ST_MODE_PSQ_GENERIC_PS0_PS1 : PPCREC_FPR_ST_MODE_PSQ_GENERIC_PS0,
		true, gqrRegister);
	return true;
}
...
bool PPCRecompilerImlGen_PS_MULS0(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterTemp = PPCRecompilerImlGen_loadOverwriteFPRRegister(
		ppcImlGenContext, PPCREC_NAME_TEMPORARY_FPR0 + 0);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM_AND_TOP, fprRegisterTemp,
		fprRegisterC);
	// if frD == frA we can multiply frD immediately and safe a copy instruction
	if (frD == frA)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_MULTIPLY_PAIR, fprRegisterD, fprRegisterTemp);
	}
	else
	{
		// we multiply temporary by frA
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_MULTIPLY_PAIR, fprRegisterTemp, fprRegisterA);
		// copy result to frD
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterD, fprRegisterTemp);
	}
	// adjust accuracy
...
bool PPCRecompilerImlGen_PS_MADDS0(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (frD == frA && frD != frB)
	{
		...
		// add frB
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_ADD_PAIR, fprRegisterD, fprRegisterB);
	}
	else
	{
		// we multiply temporary by frA
		...
		// add frB
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_ADD_PAIR, fprRegisterTemp, fprRegisterB);
		// copy result to frD
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterD, fprRegisterTemp);
	}
...
bool PPCRecompilerImlGen_PS_ADD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_ADD_PAIR, fprRegisterD, fprRegisterA);
	}
	else
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterD, fprRegisterA);
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_ADD_PAIR, fprRegisterD, fprRegisterB);
	}
	// adjust accuracy
...
bool PPCRecompilerImlGen_PS_SUB(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_SUB_PAIR, fprRegisterD, fprRegisterA, fprRegisterB);
	// adjust accuracy
	PPRecompilerImmGen_optionalRoundPairFPRToSinglePrecision(ppcImlGenContext, fprRegisterD);
	return true;
}
...
bool PPCRecompilerImlGen_PS_MUL(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterTemp = PPCRecompilerImlGen_loadOverwriteFPRRegister(
		ppcImlGenContext, PPCREC_NAME_TEMPORARY_FPR0 + 0);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterTemp, fprRegisterC);
	// todo-optimize: This instruction can be optimized so that it doesn't always use a temporary
	// register if frD == frA we can multiply frD immediately and safe a copy instruction
	if (frD == frA)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_MULTIPLY_PAIR, fprRegisterD, fprRegisterTemp);
...
bool PPCRecompilerImlGen_PS_DIV(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	// todo-optimize: This instruction can be optimized so that it doesn't always use a temporary
	// register if frD == frA we can divide frD immediately and safe a copy instruction
	if (frD == frA)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_DIVIDE_PAIR, fprRegisterD, fprRegisterB);
	}
	else
	{
		// we need a temporary register
		uint32 fprRegisterTemp = PPCRecompilerImlGen_loadOverwriteFPRRegister(
			ppcImlGenContext, PPCREC_NAME_TEMPORARY_FPR0 + 0);
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterTemp, fprRegisterA);
		// we divide temporary by frB
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_DIVIDE_PAIR, fprRegisterTemp, fprRegisterB);
		// copy result to frD
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterD, fprRegisterTemp);
	}
...
bool PPCRecompilerImlGen_PS_MADD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterTemp, fprRegisterC);
	// todo-optimize: This instruction can be optimized so that it doesn't always use a temporary
	// register if frD == frA and frD != frB we can multiply frD immediately and save a copy
	// instruction
	if (frD == frA && frD != frB)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
...
bool PPCRecompilerImlGen_PS_NMADD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterTemp, fprRegisterC);
	// todo-optimize: This instruction can be optimized so that it doesn't always use a temporary
	// register if frD == frA and frD != frB we can multiply frD immediately and safe a copy
	// instruction
	if (frD == frA && frD != frB)
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
	...
	// negate
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_NEGATE_PAIR, fprRegisterD, fprRegisterD);
	// adjust accuracy
	// PPRecompilerImmGen_optionalRoundPairFPRToSinglePrecision(ppcImlGenContext, fprRegisterD);
	// Splatoon requires that we emulate flush-to-denormals for this instruction
	// PPCRecompilerImlGen_generateNewInstruction_fpr_r(ppcImlGenContext,
	// NULL,PPCREC_IML_OP_FPR_ROUND_FLDN_TO_SINGLE_PRECISION_PAIR, fprRegisterD, false);
	return true;
}
...
bool PPCRecompilerImlGen_PS_MSUB(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (frD == frA && frD != frB)
	{
		...
		// sub frB
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_SUB_PAIR, fprRegisterD, fprRegisterB);
	}
	else
	{
		// we multiply temporary by frA
		...
		// sub frB
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_SUB_PAIR, fprRegisterTemp, fprRegisterB);
		// copy result to frD
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterD, fprRegisterTemp);
	}
...
bool PPCRecompilerImlGen_PS_SUM0(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r_r(ppcImlGenContext, PPCREC_IML_OP_FPR_SUM0,
														   fprRegisterD, fprRegisterA, fprRegisterB,
														   fprRegisterC);
	// adjust accuracy
	PPRecompilerImmGen_optionalRoundPairFPRToSinglePrecision(ppcImlGenContext, fprRegisterD);
	return true;
...
bool PPCRecompilerImlGen_PS_SUM1(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r_r(ppcImlGenContext, PPCREC_IML_OP_FPR_SUM1,
														   fprRegisterD, fprRegisterA, fprRegisterB,
														   fprRegisterC);
	// adjust accuracy
	PPRecompilerImmGen_optionalRoundPairFPRToSinglePrecision(ppcImlGenContext, fprRegisterD);
...
bool PPCRecompilerImlGen_PS_NEG(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_NEGATE_PAIR, fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_PS_ABS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(ppcImlGenContext, PPCREC_IML_OP_FPR_ABS_PAIR,
													   fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_PS_RES(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_FRES_PAIR, fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_PS_RSQRTE(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_FRSQRTE_PAIR, fprRegisterD, fprRegisterB);
	return true;
}
...
bool PPCRecompilerImlGen_PS_MR(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (frB != frD)
	{
		...
		uint32 fprRegisterD =
			PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_PAIR, fprRegisterD, fprRegisterB);
	}
	return true;
}
...
bool PPCRecompilerImlGen_PS_SEL(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterD =
		PPCRecompilerImlGen_loadOverwriteFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frD);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_SELECT_PAIR, fprRegisterD, fprRegisterA, fprRegisterB,
		fprRegisterC);
	return true;
}
...
bool PPCRecompilerImlGen_PS_MERGE00(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	else
	{
		...
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_TOP, fprRegisterD, fprRegisterB);
		// copy bottom of frA
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM, fprRegisterD, fprRegisterA);
	}
	return true;
}
...
bool PPCRecompilerImlGen_PS_MERGE01(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (fprRegisterD != fprRegisterB)
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_TOP_TO_TOP, fprRegisterD, fprRegisterB);
	if (fprRegisterD != fprRegisterA)
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM, fprRegisterD, fprRegisterA);
...
bool PPCRecompilerImlGen_PS_MERGE10(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	if (frA == frB)
	{
		// swap bottom and top
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_AND_TOP_SWAPPED, fprRegisterD,
			fprRegisterA);
	}
	else if (frA == frD)
	{
	...
	else if (frB == frD)
	{
		...
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_TOP_TO_TOP, fprRegisterD, fprRegisterA);
		// swap lower and upper half of frD
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_AND_TOP_SWAPPED, fprRegisterD,
			fprRegisterD);
	...
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_TOP_TO_BOTTOM_AND_TOP, fprRegisterD,
			fprRegisterA);
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_BOTTOM_TO_BOTTOM, fprRegisterD, fprRegisterB);
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
...
bool PPCRecompilerImlGen_PS_MERGE11(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	{
		PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
			ppcImlGenContext, PPCREC_IML_OP_FPR_COPY_TOP_TO_BOTTOM, fprRegisterD, fprRegisterA);
	}
	else
	{
		debugBreakpoint();
...
bool PPCRecompilerImlGen_PS_CMPU1(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	uint32 fprRegisterB =
		PPCRecompilerImlGen_loadFPRRegister(ppcImlGenContext, PPCREC_NAME_FPR0 + frB);
	PPCRecompilerImlGen_generateNewInstruction_fpr_r_r(
		ppcImlGenContext, PPCREC_IML_OP_FPR_FCMPU_TOP, fprRegisterA, fprRegisterB, crfD);
	return true;
}