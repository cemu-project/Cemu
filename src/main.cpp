...
void reconfigureGLDrivers()
{
	...
	const fs::path nvCacheDir = GetPath(ActiveSettings::GetCachePath(), "shaderCache/driver/nvidia/");
...
int mainEmulatorHLE()
{
	...
	// init title list
	CafeTitleList::Initialize(GetPath(ActiveSettings::GetUserDataPath(), "title_list_cache.xml"));
