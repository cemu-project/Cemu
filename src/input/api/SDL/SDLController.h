...
class SDLController : public Controller<SDLControllerProvider>
{
  public:
	...
	const SDL_JoystickGUID& get_guid() const
	{
		return m_guid;
	}

	constexpr static SDL_JoystickGUID kLeftJoyCon{0x03, 0x00, 0x00, 0x00, 0x7e, 0x05, 0x00, 0x00,
												  0x06, 0x20, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00};
	constexpr static SDL_JoystickGUID kRightJoyCon{0x03, 0x00, 0x00, 0x00, 0x7e, 0x05, 0x00, 0x00,
												   0x07, 0x20, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00};
	constexpr static SDL_JoystickGUID kSwitchProController{0x03, 0x00, 0x00, 0x00, 0x7e, 0x05,
