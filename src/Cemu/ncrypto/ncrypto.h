...
struct ECCSig
{
	...
	{
		return memcmp(this->r, otherSig.r, sizeof(this->r)) == 0 &&
			   memcmp(this->s, otherSig.s, sizeof(this->s)) == 0;
	}
...
struct CertECC
{
	...
	static CertECC generateCertificate(uint32 signerTitleIdHigh, uint32 signerTitleIdLow,
...
class ETicketParser // .tik parser
{
  public:
	...
	static bool Depersonalize(uint8* ticketData, size_t ticketSize, uint32 deviceId,
