...
public class SingleSelectionRecyclerViewItem<T> implements RecyclerViewItem {
    ...
    public SingleSelectionRecyclerViewItem(String label, String description, SelectionAdapter<T> selectionAdapter, OnItemSelectedListener<T> onItemSelectedListener) {
        this.label = label;
