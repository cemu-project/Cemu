...
class LaunchSettings
{
  public:
	...
	static bool ForceIntelLegacyEnabled()
	{
		return s_force_intel_legacy;
	}
	...
	static std::string GetActURLPrefix()
	{
		return serviceURL_ACT;
	}
	static std::string GetServiceURL_ecs()
	{
		return serviceURL_ECS;
	}
  ...
  private:
	...
	static bool ExtractorTool(std::wstring_view wud_path, std::string_view output_path,
